...
//   regardless of color.  Per-voxel color is painted into the TextureAtlas
...
// In each 2D slice, scan for maximal rectangles of exposed faces (color-
...
public:
    ...
    // per-voxel colors at arbitrary pixel density.
    struct Quad {
...
private:
    ...
    static void meshFace(const VoxelGrid &grid,
                         Face face,
                         std::vector<Quad> &out);
};
